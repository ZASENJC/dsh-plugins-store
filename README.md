...
> [!IMPORTANT]
> **破坏性变更：** 项目与插件标识已统一为 `dsh-plugins-store`，旧包名、运行时 ID 和接口不再兼容。站点已由 `dsh.aitreez.com` 迁移至 [dshmk.com](https://dshmk.com/)，公开 API 更新为 [api.dshmk.com](https://api.dshmk.com/)。
